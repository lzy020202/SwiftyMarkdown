...
extension SwiftyMarkdown {
	...
	func color( for line : SwiftyLine ) -> NSColor {
		...
		case .unorderedList, .unorderedListIndentFirstOrder, .unorderedListIndentSecondOrder, .orderedList, .orderedListIndentFirstOrder, .orderedListIndentSecondOrder, .unorderedCustomListIndentFirstOrder, .unorderedCustomListIndentSecondOrder:
			return body.color
		case .yaml:
			return body.color
		case .referencedLink:
